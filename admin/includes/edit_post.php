...
<form action="" method = "post" enctype = "multipart/form-data">
    ...
    <div class="form-group">
        ...
        <img name = "post_image" src="../images/<?php echo $post_image;?>" alt="" width = "100">
    ...
    <div class="form-group">
        ...
        rows = "10" class = "form-control"><?php echo $post_content ?></textarea>
    </div>
b  
    <div class="form-group">
        <input type="submit" class = "btn btn-primary btn-lg" name = "update_post" value = "publish post">
    </div>
</form>
<?php
        }
